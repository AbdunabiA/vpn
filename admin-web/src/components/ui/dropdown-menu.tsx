...
// Minimal subset of shadcn's dropdown-menu: Root, Trigger, Content, Item,
// Label, Separator. Enough for the user-detail action bar's tier picker.
...
// Re-exports of unused-by-us primitives so that future `shadcn add` commands
// extending this file don't need to import them separately.
...
// Icons re-exported for consumers that want Check / ChevronRight inline.
export { Check as DropdownMenuCheckIcon, ChevronRight as DropdownMenuChevronIcon };
